...
- [x] Import the `useState` hook and set up state to keep your team members list. App.js, line 43
...
- [x] You will have to decide which component is responsible for maintaining the _state_ of the form (`Form` itself, or its parent `App`). Each approach has advantages and disadvantages. --> The App component is managing my state
