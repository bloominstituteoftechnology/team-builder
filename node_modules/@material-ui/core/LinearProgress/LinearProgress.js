...
var LinearProgress = _react.default.forwardRef(function LinearProgress(props, ref) {
  ...
  var className = (0, _clsx.default)(classes.root, classNameProp, color === 'primary' ? classes.colorPrimary : classes.colorSecondary, {
  ...
  var bar1ClassName = (0, _clsx.default)(classes.bar, (variant === 'indeterminate' || variant === 'query') && classes.bar1Indeterminate, color === 'primary' ? classes.barColorPrimary : classes.barColorSecondary, {
